...
@property (nonatomic, strong) IBOutlet NSLayoutConstraint * _Null_unspecified mediaTrailingConstraint;
@property (nonatomic) BOOL showImage;
@property (nonatomic, readonly, copy) NSString * _Nonnull shortText;
@property (nonatomic, readonly, copy) NSString * _Nonnull mediumText;
@property (nonatomic, readonly, copy) NSString * _Nonnull longText;
- (IBAction)switchDidChange:(id _Nonnull)sender;
- (void)configureView;
- (void)viewDidLoad;
