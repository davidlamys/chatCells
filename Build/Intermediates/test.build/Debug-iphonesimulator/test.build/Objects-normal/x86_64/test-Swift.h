...
SWIFT_CLASS("_TtC4test20DetailViewController")
@interface DetailViewController : UIViewController
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified detailDescriptionLabel;
@property (nonatomic, weak) IBOutlet UIView * _Null_unspecified bubble;
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified imageView;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified textLabel;
@property (nonatomic, weak) IBOutlet NSLayoutConstraint * _Null_unspecified mediaViewTopConstraint;
@property (nonatomic, weak) IBOutlet NSLayoutConstraint * _Null_unspecified mediaViewHeight;
@property (nonatomic, weak) IBOutlet NSLayoutConstraint * _Null_unspecified mediaViewWidth;
@property (nonatomic, weak) IBOutlet NSLayoutConstraint * _Null_unspecified mediaTrailingConstraint;
@property (nonatomic, weak) IBOutlet NSLayoutConstraint * _Null_unspecified leftAvatarFixedWidthConstraint;
@property (nonatomic, weak) IBOutlet NSLayoutConstraint * _Null_unspecified rightAvatarFixedWidthConstraint;
- (void)configureView;
- (void)viewDidLoad;
